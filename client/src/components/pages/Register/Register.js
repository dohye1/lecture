        ...
        <div className="register-container">
            ...
            <section className="register-form">
                <form>
                    ...
                    <div className="input-box">
                        <input type="text" name="name" id="name" autoComplete="off" required onChange={(e) => setName(e.currentTarget.value)} />
                        <label htmlFor="name" className={NameCss}>NAME</label>
                    </div>
                    <div className="input-box">
                        <input type="password" name="pw" id="pw" autoComplete="off" required onChange={(e) => setPassword(e.currentTarget.value)} />
                        <label htmlFor="pw" className={PwCss}>PASSWORD</label>
                    </div>
                    <div className="input-box">
                        <input type="password" name="confirm-pw" id="confirm-pw" autoComplete="off" required onChange={handlePw} />
                        <label htmlFor="confirm-pw" className={ConfirmPwCss}>CONFIRM PASSWORD</label>
                    </div>
                    <div className="input-box">
                        <input type="text" name="id_num" id="id_num" autoComplete="off" required onChange={(e) => setIdNum(e.currentTarget.value)} />
                        <label htmlFor="id_num" className={IdNumCss}>ID NUM</label>
                    </div>
